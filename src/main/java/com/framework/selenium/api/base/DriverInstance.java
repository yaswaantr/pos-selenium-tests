...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.40.49.128:32000/wd/hub"), firefoxOptions));
			break;
		case "edge":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://20.40.49.128:32000/wd/hub"), edgeOptions));
			break;	
		case "ie":
